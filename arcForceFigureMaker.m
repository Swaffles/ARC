                ...
                for k = 1:length(q)
                    ...
                    if yData3{counter}{1,4} == 0   
                         errorbar(yData3{counter}{:,"Heading"},yData3{counter}{:,barelabel},yData3{counter}{:,"Stdev"},...
                             'Marker','o','MarkerFaceColor',col(colCounter,:),'Color',col(colCounter,:),'LineWidth',1,...
                             'LineStyle','-','DisplayName',strcat({'\delta= '},string(yData3{counter}{1,"Steering"}),{'^\circ; U='},...
                             string(yData3{counter}{1,"Target Flow Speed"}),{'m/s'}));
                    elseif yData3{counter}{1,4} > 0
                        errorbar(yData3{counter}{:,"Heading"},yData3{counter}{:,barelabel},yData3{counter}{:,"Stdev"},...
                             'Marker','<','MarkerFaceColor',col(colCounter,:),'Color',col(colCounter,:),'LineWidth',1,...
                             'LineStyle','--','DisplayName',...
                             strcat({'\delta= '},string(yData3{counter}{1,"Steering"}),{'^\circ; U='},...
                             string(yData3{counter}{1,"Target Flow Speed"}),{'m/s'}));
...
%                              {' deg; U= '},string(yData3{counter}{1,"Target Flow Speed"}),{' m/s'}));
            ...
            xlabel(tile,"Heading, deg");
            xticks(0:22.5:max(yData{:,"Heading"}));
            axis padded
            ylabel(tile,label);
            lgd = legend('Location','southoutside','NumColumns',2,"Interpreter","tex");
            fontsize(ax,10,"points");
            lgd.FontSize = 8; % much smaller to fit
